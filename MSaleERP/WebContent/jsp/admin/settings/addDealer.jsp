...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <div class="widget-box">
         ...
         <h5>Dealer List</h5>
            <span class="label label-important" name="dealerCount" id="dealerCount" style="height: 15px;"></span>
          </div>
          <div class="widget-content nopadding">
        ...
        %>            
                  ...
                  <td><%=varcontactno%></td>
                  <td><%=varemailid%></td>
                  <td> <a href="#update" data-toggle="modal"  onclick="getSr(<%=intdealerid%>)">Update</a> / <a onclick="getDeleteId('<%=intdealerid %>')" href="#DeleteConfirmBox" data-toggle='modal'>Delete</a>
                  </td>
                </tr>
                	<%
                	i++;
						...
						<div class="widget-content nopadding">
				            ...
				            <div class="control-group">
				              ...
				              <div class="controls">
				                ...
				                <input type="text" class="span11" placeholder="Dealer Name" value="<%=vardealername%>" name="update_dealer_name" onkeyup="this.value=this.value.toUpperCase();" style="width: 300px;" required />
				              </div>
				            </div>
				             <div class="control-group">
				              <label class="control-label"><span style="color: red;">*</span>Contact No :</label>
				              	...
				              	<div class="controls controls-row">
				            		<input type="text" placeholder="Contact No" class="span6 m-wrap" value="<%=varcontactno%>" onkeypress="return isNumber(event)" maxlength="10" name="update_contact_no"  style="width: 300px;"> 
				          		</div>
				            </div>
				            <div class="control-group">
				              <label class="control-label">Email Id :</label>
				              <div class="controls">
				                <input type="email" class="span11" placeholder="Email Id" value="<%=varemailid %>" name="update_email_id" style="width: 300px;: "/>
				              </div>
				            </div>
