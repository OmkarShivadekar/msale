...
<%@page import="servletStore.payment.getDealerName"%>
	...
	<div id="content">
		...
		<div id="content-header">
			<div id="breadcrumb">
				...
				<a href="/MSaleERP/jsp/admin/purchase/newMobilePurchase2.jsp" class="current">New Purchase</a>
			</div>
		</div>
		<!--End-breadcrumbs-->
		...
		<div class="container-fluid">
		        ...
		        <div class="widget-content nopadding">
		            ...
		            <td style="width: 400px;" valign="top">
		              <label class="control-label" style="margin-left: -70px;">Date :</label>
		               ...
		               <label class="control-label" style="margin-left: -70px;">Dealer :</label>
		              <div class="controls" style="position:relative; right:50px; width:220px">
		                
		                
		                <select style="width:220px" name="dealerId" tabindex="1" id="dealerList" onchange="window.location.href='/MSaleERP/jsp/admin/purchase/newMobilePurchase2.jsp?dealerId='+this.value">
		                	...
		                	while(itrGetDealerList.hasNext()){
		                		...
		                		System.out.print("id "+id+" dealid="+dealerId);
		              ...
		              <div class="controls">
		                <input type="text" tabindex="2" class="span2" placeholder="Invoice No" style="margin-left: -50px; width: 220px;" id="billNumber" name="billNo" onblur="checkInvoice(this.value,<%=dealerId %>,this.id)" style="width: 220px;"   />
		              ...
		              <label class="control-label" style="margin-left: -70px;">Total Amount :</label>
		                ...
		                <input type="text" tabindex="3" name="totalBillAmount" id ="totalBillPrice" style="margin-left: -50px;" onkeypress="return isNumber(event)" placeholder="Total Invoice Amount"   />
		              </div>
		              <table>
		              	<tr>
		              		<td><label class="control-label" style="margin-left: -70px;">Select Model :</label></td>
		              		<td>
		              		 <input name=""  tabindex="4" list="getList" id="modelDemo" onblur="getModelBox(this.value,this.id)" onkeyup="searchModel(this.value,this.id,<%=dealerId %>)" autocomplete="off" type="text" class="span4" style="position:relative; left:16px; width:221px" placeholder="Model"/>
		              	...
		              	<%
		                String gModel="";
		                 List modelList = rd.getModelList(request.getParameter("dealerId").toString());
		                 ...
		                 { 
		                	 ...
		                	 while(itr.hasNext())
		                	 {
		              		...
		              		<td>&nbsp;<a href="#addModel" type="button" style="position: relative; left: 13px;" data-toggle="modal" ><span class="badge badge-inverse"><i class="icon-plus"></i></span></a></td>
		              	</tr>
		              </table>
		              ...
		              <div class="controls" style="position:relative; right:35px; font-size:14px; width:205px;">
		              <div style="width:200px;">
		                	<input tabindex="5" type="radio" name="hsnSac" id="85171290" value="85171290" checked="checked" style="position:relative; bottom:2px">&nbsp;85171290
		                	&nbsp;&nbsp;&nbsp;
		            ...
		            <label class="control-label" style="margin-left: -70px;">MRP :</label>
		              <div class="controls">
		                <input tabindex="6" type="text" id="price" class="span11" style="margin-left: -50px; width: 220px;" placeholder="Price" name="price" value="" onkeypress="return isNumber(event)" style="width: 221px;"  />
		              </div>
		            
		            <label class="control-label" style="margin-left: -70px;">Quantity :</label>
		              <div class="controls">
		                <input type="number" tabindex="7" id="member" style="margin-left: -50px; width: 220px;" class="span11" onkeydown="return stopTab(event)" onkeyup="turnOnText()" onKeyPress="addFields(event)" placeholder="Quantity" name="qty" value="" style="width: 221px;"  />
		               <p id="onEnter"></p>
		              </div>
		              ...
		              <input name="puresubmit" type="submit" class="btn btn-success" value="submit" id="pureSubmit" onclick="Alert.render('DATABASE UPDATED SUCCESS')" disabled/>
		            </div>
		            <%} %>
		          ...
		          <div class="widget-content nopadding">
		          <table class="table table-bordered table-striped" id="tid" style="text-align: center; width:683px;">
		              <thead>
		                <tr>
          ...
          <form action="" method="post">
            <table class="table table-bordered table-striped">
              ...
              {%>
              <%
              List demoList1=rd.getPurchaseDetail1(request.getParameter("dealerId").toString());
              	...
              	<tr>
					...
					<table  style="position: relative; bottom: 5px;">
		              ...
		              <% RequireData rd2=new RequireData();
		              	 List demoList2=rd2.getPurchaseDetail2(invoiceId.toString(),dealerId);
					...
					<% String[] dop=itr1.next().toString().split("-"); %>
	              	...
	              	<td style="text-align:center"><a href="#editIMEI" onclick="updateImeino('<%=dealerId %>','<%=invoiceId %>','<%=aliasNme %>')" data-toggle="modal">Update</a>|<a href="#deleteConfirmBox" onclick="getDeleteId(<%=invoiceId %>,<%=dealerId %>,'<%=aliasNme %>',<%=count %>)" data-toggle="modal">Delete</a></td>
              	</tr>
              	<%} %>
              	<%} %>
              </tbody>
			...
			<div class="modal-body">
					...
					<label class="control-label">Select Color &nbsp;</label>
						<div class="controls" style="margin: 0 auto;">
							<select name="purBrandId" id="purBrandId" style="width:220px;">
			                   <% 
			                	List brandListById = rd.getBrandListById(Integer.parseInt(dealerId));
			                 
			                 if(brandListById!= null)
			                 {
			                     Iterator itr =brandListById.iterator();
			                	 while(itr.hasNext())
			                	 {		
			                		 %>
						...
						<label class="control-label">Select Color &nbsp;</label>
						<div class="controls" style="margin: 0 auto;">
							<select name="purMcolor" id="purMcolor" style="width:220px;">
					...
					<div class="modal-body">
						<div class="form-group">
							...
							<div class='controls' style="margin: 0 auto;">
								...
								<input type="hidden" name="uModelBrandId" value="<%=dealerId %>" />
							...
							<div class='controls' style="margin: 0 auto;">
								<input type="text" id ="ubillamount" disabled/>
							</div>
						</div>
					</div>
					<div class="modal-footer">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<input type="hidden" id="dealerId" name="dDealerId">
...
function setFocusToTextBox() {
	clock();
	callToError();
	var sFocus=document.getElementById("s2id_dealerList");
	sFocus.setAttribute("class","select2-container select2-container-active");
	showsnack();
		...
		if (this.readyState == 4 && this.status == 200) {
			...
			for(var i=0;i<wholeData.length-1;i++)
				...
				dataDiv.innerHTML+="<label class='control-label'>Model Name &nbsp; </label>"
					...
					+"<div class='controls' style='width: 220px;position:relative;left:20px'>"
					...
					for(var j=0;j<imeiList.length-1;j=j+2)
	 					{
						newdiv.innerHTML+="<input type='hidden' name='uImeiId"+k+"' value='"+imeiList[j]+"'><input type='text' pattern='[0-9]*' maxlength='17' name='uImei"+k+"' value='"+imeiList[j+1]+"'  ><br><div style='height:5px;'></div>";
	 					k++;
	 					l++;
	 					}
...
function getDeleteId(invoiceId, dealerId, aliasName, count)
{
...
function getModelBox(str,id) {
	if(!document.getElementById(id).value==""){
		...
		xhttp.open("POST", "/MSaleERP/Purchase.do?modelAlias="+str, true);
		xhttp.send();
	}
}

//finding modelName
function searchModel(str,id,dId) {
	if (str == " ") {
		...
		if(!document.getElementById(id).value==""){
			...
			xhttp.open("POST", "/MSaleERP/Purchase.do?findName="+str+"&dealerId="+dId, true);
			xhttp.send();
		}
	}
}
function searchName() {
	var id=document.getElementById("purBrandId").value;
...
function checkInvoice(value,dealerId,id) {
	var xhttp;
	xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
	...
	xhttp.open("POST","/MSaleERP/Purchase.do?validateInvoiceNo="+value+"&statusbrid="+dealerId, true);
	xhttp.send();
	}
