...
<body onload="myFunction()">
	...
	List details = rd.getDummySaleData(invoiceId);
    ...
    if(details!= null)
    {
    	...
    	//SELECT `dummyid`, `varcustname`, `varaddress`, `varcontactno`, `varcustgst`,
    	//`varsaledate`, `varaliasnamemodel`, `varimeino`, `varbatteryno`, `varchargerno`, 
    	//`varsaleprice`, `intdiscount` FROM
    	...
    	cust_gst=details.get(4).toString();
    	sale_date = details.get(5).toString();
    	model_no = details.get(6).toString();
    	imei_no1 = details.get(7).toString();
    	battery_no = details.get(8).toString();
    	charger_no = details.get(9).toString();
    	paid_amount = details.get(10).toString();
    	discount = details.get(11).toString();
    	hsn = details.get(12).toString();
    	imei_no2 = details.get(13).toString();
    	snno = details.get(14).toString();
...
<div id="print">
	<div id="page-wrap" style="transform : rotate(90deg); ">
		...
		<table style="width: 670px;">
				...
				<td width="350px">
					<div id="logo">
						...
						<img id="image" src="/MSaleERP/config/img/simplelogo.png"
							alt="logo" /> <br> <span>Prop.Mr.Fulchand Dhwale :
							7020619986</span>
					</div>
				</td>
				<td><div>
			...
			<tr>
				<td>GSTIN / PAN:-<% if(!cust_gst.equals("null")){out.print(cust_gst);} %></td>
		...
		<table id="items">
			...
			<tr class="item-row">
				...
				<td><div style="line-height: 1.5">
					...
					IMEI No-1 : &nbsp;&nbsp;&nbsp;&nbsp; <%=imei_no1 %> <br><br> 
					IMEI No-2: &nbsp;&nbsp;&nbsp;&nbsp; <% if(!imei_no2.equals("null")){out.print(imei_no2);} %> <br><br>
					Serial No :  &nbsp;&nbsp;&nbsp;&nbsp; <% if(!snno.equals("null")){out.print(snno);} %> <br> <br>
		...
		<table>
			<tr>
				<td style="width: 800px; height: 80px;"><i style="font-size: 8px;">
						...
						payable on the sale has been paid or shall be paid."</i><br><span style="float: right;">For Suraj Electronics & Mobile Shopee</span><br> <br> <br>
