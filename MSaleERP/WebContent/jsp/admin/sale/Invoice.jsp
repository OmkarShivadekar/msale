	...
	function showModel(str) {
		...
		xhttp.onreadystatechange = function() {
			if (this.readyState == 4 && this.status == 200) {
				var textf=document.getElementById("imeino").innerHTML = "<option value=''></option>";
				...
				document.getElementById("hscode").value = hsno;
				document.getElementById("hscode_dis").value = hsno;
				for (var i = 2; i < demoStr.length; i++) {
					text += "<option value="+demoStr[i]+">" + demoStr[i]
							+ "</option>";
				}
				
				document.getElementById("imeino").innerHTML =textf + text;
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class='form-horizontal' method='post' name="editdatasave"
						...
						action="/MSaleERP/EditPrintInvoice">
						<div class='form-group'>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="widget-box" style="width: 800px; margin: 0 auto;">
							...
							<form name="form" id="form" action="/MSaleERP/SaleInvoice"
								method="post">
								<div class="widget-content">
									...
									<%
										...
										List modelname = data.getAliasName();
										if (modelname != null) {
											Iterator itr = modelname.iterator();
									%>
									...
									<div class="row-fluid">
										<div class="span12">
											...
											<table style="margin: 0 auto; width: 770px;">
												<tbody>
													<tr>
														<td style="text-align: right;"><span style='color: red;'>*</span>Model No.<select
															name="modelname" onchange="showModel(this.value)"
															id="modelname" style="" class="span9">
																<option value=''></option>
																<%
																						while (itr.hasNext()) {
																					%>
														...
														<td style="text-align: right;"><span style='color: red;'>*</span>Amount : <input
															...
															name="div_modelrate1" required /></td>

													</tr>
													<tr>

														<td style="text-align: right;"><span style='color: red;'>*</span>IMEI
															No.<select name="imeino" onchange="showIMEI()"
																		id="imeino" class="span9">
