...
<% if(request.getAttribute("status")!=null){ %>
  ...
  <div id="content-header">
    ...
    <h1>Create Organization Invoice</h1>
  </div>
<!--End-breadcrumbs-->
  ...
  <div class="container-fluid">
    ...
    <div class="widget-box">
        ...
        <div class="widget-content nopadding" >
          <form action="/MSaleERP/CreateInvoice.do" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>Invoice Header :</span></label>
              <div class="controls">
                <input type="text" tabindex="1" class="span4" placeholder="Shop name" id="shopName" name="orgname"  required style="position:relative; left:10px;" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>Tag Line :</label>
              <div class="controls">
                <input type="text" tabindex="2" class="span4" placeholder="Owner's name" name="tag"  required style="position:relative; left:10px;"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>Address In Short  :</label>
              <div class="controls">
                <input type="text" tabindex="3" class="span4" placeholder="Address In Short" name="orgaddress"  required style="position:relative; left:10px;" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>Tal  :</label>
              <div class="controls">
                <input type="text" tabindex="4" class="span4" placeholder="Tal" name="tal"  required style="position:relative; left:10px;" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>Dist  :</label>
              <div class="controls">
                <input type="text" tabindex="5" class="span4" placeholder="Dist" name="dist"  required style="position:relative; left:10px;" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>Phone No :</label>
              <div class="controls">
                <input type="text" tabindex="6" class="span4" placeholder="Phone No" name="phoneNo" maxlength="10" onkeypress="return isNumber(event)"  required style="position:relative; left:10px;" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>PAN  :</label>
              <div class="controls">
                <input type="text" tabindex="7" class="span4" placeholder="PAN" name="pan"  required style="position:relative; left:10px;" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>GSTIN NO :</span></label>
              <div class="controls">
                <input type="text" tabindex="8" class="span4" placeholder="GSTIN NO" id="" name="gstin" required style="position:relative; left:10px;" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>Place Of Supply  :</label>
              <div class="controls">
                <input type="text" tabindex="9" class="span4" placeholder="Place Of Supply" name="place"  required style="position:relative; left:10px;" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label offset1"><sup style="color: red" title="Mendatory Field">*</sup>State Code :</label>
              <div class="controls">
                <input type="text" tabindex="10" class="span4" placeholder="State Code" name="scode"  required style="position:relative; left:10px;" />
              </div>
            </div>
            <center>
