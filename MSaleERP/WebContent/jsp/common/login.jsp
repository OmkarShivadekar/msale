...
<head>
        ...
        <link rel="stylesheet" href="/MSaleERP/config/css/matrix-login.css" />
	...
	<style type="text/css">
	body {
	    background-image: url("/MSaleERP/config/img/secure.jpg");
	...
	#loginbox{
		background-image: url("/MSaleERP/config/img/secure3.jpg");	 
...
else
{
	...
	var url="/MSaleERP/LoginAction.do?Activate=1&activationKey="+key;  
